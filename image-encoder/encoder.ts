...
namespace Options {
    ...
    export const compression = document.getElementById("compression") as HTMLSelectElement;
}
...
button.addEventListener("click", async () => {
    ...
    let blob: Blob;
    if(Options.compression.value != "none") try {
        const gzip = file.stream().pipeThrough(new CompressionStream(Options.compression.value as CompressionFormat));
